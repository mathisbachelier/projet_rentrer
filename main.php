...
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="position: sticky; top : 0px; z-index : 1; background-color: #6a994e !important;">
            <div class="container">
                <a class="navbar-brand" >Cook'nShare</a>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card mb-4" >
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">recette de vrai sushi japonais !!</p>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        <li><a id="types" href="categorie.php?id=1">Entré</a></li>
                                        <li><a id="types" href="categorie.php?id=2">Plat</a></li>
                                        <li><a id="types" href="categorie.php?id=3">Dessert</a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        <li><a id="types" href="categorie.php?id=4">Apperitif</a></li>
                                        <li><a id="types" href="categorie.php?id=5">Autres</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
